...
class Card extends Button {
  constructor (parentNode, baseRecord, click){
      ...
      let imgURL = 'assets/'+this.baseRecord.imageSrc;
      ...
      let imgWrapperB = new Control(this.sideB.node,'div', 'card_img', '');
      ...
      let imgWrapperA = new Control(this.sideA.node,'div', 'card_img', '');
